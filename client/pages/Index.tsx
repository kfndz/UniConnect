        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="p-8 rounded-xl bg-accent-50 border border-accent-200 hover:shadow-lg transition-shadow">
              ...
              <p className="text-muted-foreground">
                Encontre grupos de interesse em tecnologia, artes, esportes,
                estudos acadêmicos e mais.
              </p>
            </div>
            ...
            <div className="p-8 rounded-xl bg-primary-100/30 border border-primary-200 hover:shadow-lg transition-shadow">
              ...
              <p className="text-muted-foreground">
                Compartilhe avisos, convites, divulgue eventos e oportunidades
                com a comunidade.
              </p>
            </div>
            ...
            <div className="p-8 rounded-xl bg-accent-50 border border-accent-200 hover:shadow-lg transition-shadow">
              ...
              <p className="text-muted-foreground">
                Crie seu perfil com informações acadêmicas e interesses
                culturais únicos.
              </p>
            </div>
            ...
            <div className="p-8 rounded-xl bg-primary-100/30 border border-primary-200 hover:shadow-lg transition-shadow">
              ...
              <p className="text-muted-foreground">
                Receba lembretes de eventos, novos grupos e interações
                importantes.
              </p>
            </div>
          </div>
