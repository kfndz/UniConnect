...
import { Edit, Save, X, BookOpen, Calendar, Users } from "lucide-react";
      ...
      <div className="max-w-2xl mx-auto">
        ...
        <Card className="p-8 mb-8">
          <div className="flex items-start justify-between mb-6">
            ...
            <Button
              ...
              className={isEditing ? "bg-orange-500 hover:bg-orange-600" : "bg-primary-500 hover:bg-primary-600"}
            >
              {isEditing ? (
                <>
        ...
        {isEditing && (
          <Card className="p-6 mb-8 bg-primary-50 border-primary-200">
            <h3 className="text-lg font-bold text-foreground mb-4">Editar Perfil</h3>
            <div className="space-y-4">
              ...
              <Button className="w-full bg-green-500 hover:bg-green-600">
                <Save className="mr-2 w-4 h-4" /> Salvar Alterações
              </Button>
            </div>
          </Card>
        )}
        ...
        <Card className="p-6 mb-8">
          <h3 className="text-lg font-bold text-foreground mb-4">Interesses Acadêmicos e Culturais</h3>
          <div className="mb-4">
            <div className="flex gap-2 mb-4">
              ...
              />
              <Button onClick={handleAddInterest} className="bg-primary-500 hover:bg-primary-600">
                Adicionar
              </Button>
            </div>
